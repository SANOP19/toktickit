...
npm run prisma:seed    # Seed categories, related systems, and users
...
```bash
# Run Playwright multi-role E2E tests from project root
...
- `lab3-staging`: Integration branch for Lab 3
